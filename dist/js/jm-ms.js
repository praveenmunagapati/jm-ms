...
if (typeof global !== 'undefined' && global) {
    ...
    if (!jm.ms) {
        ...
        _ms.client = function (opts, cb) {
            root.client(opts, cb);
            return undefined;
        };

        _ms.server = function (opts, cb) {
            root.server(opts, cb);
            return undefined;
        };
    }
...
var logger = _jmLogger2.default.getLogger('jm-ms-ws:client');
var Err = _jmErr2.default.Err;

var MAXID = 999999;
var defaultPort = 3100;
var defaultUri = 'ws://localhost:' + defaultPort;
var err_network = _jmErr2.default.err(Err.FA_NETWORK);
    ...
    return function () {
        ...
        doc = {
            request: function request(opts, cb) {
                ...
                opts = r.opts;
                cb = r.cb;
                if (!connected) return cb(err_network, Err.FA_NETWORK);
